...
==================
*/
export void DeathmatchScoreboardMessage(entity &ent, entityref killer);

export void MoveClientToIntermission(entity &ent);

export void BeginIntermission(entity &targ);
...
==================
*/
export void Cmd_Score_f(entity &ent);
...
==================
*/
export void Cmd_Help_f(entity &ent);
...
===============
*/
export void G_SetStats(entity &ent);
...
===============
*/
export void G_SetSpectatorStats(entity &ent);
...
===============
*/
export void G_CheckChaseStats(entity &ent);

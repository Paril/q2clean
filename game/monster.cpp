...
static void M_MoveFrame(entity &self)
{
	...
	int index = self.frame - move->firstframe;
...
#ifdef GROUND_ZERO
inline void M_HandleDamage(entity &targ, entity &attacker, entity &inflictor)
#else
inline void M_HandleDamage(entity &targ, entity &attacker)
#endif
{

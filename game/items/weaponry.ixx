...
export module items.weaponry;

import items.list;

export bool Add_Ammo(entity &ent, const gitem_t &it, int32_t count)
{
	if (!ent.is_client())
		return false;
...
export bool Pickup_Ammo(entity &ent, entity &other)
{
...
export void Drop_Ammo(entity &ent, const gitem_t &it)
{
...
export bool Pickup_Weapon(entity &ent, entity &other)
{
...
export void Use_Weapon(entity &ent, const gitem_t &it)
{
...
export void Drop_Weapon(entity &ent, const gitem_t &it)
{
	if ((dm_flags) dmflags & DF_WEAPONS_STAY)
		return;

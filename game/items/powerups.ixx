...
export bool Pickup_Bandolier(entity &ent, entity &other)
{
...
export bool Pickup_Pack(entity &ent, entity &other)
{
...
export void Use_Breather(entity &ent, const gitem_t &it)
{
	ent.client->pers.inventory[it.id]--;
	ValidateSelectedItem(ent);
...
export void Use_Envirosuit(entity &ent, const gitem_t &it)
{
	ent.client->pers.inventory[it.id]--;
	ValidateSelectedItem(ent);
...
export void Use_Invulnerability(entity &ent, const gitem_t &it)
{
	ent.client->pers.inventory[it.id]--;
	ValidateSelectedItem(ent);
...
export void Use_Silencer(entity &ent, const gitem_t &it)
{
	ent.client->pers.inventory[it.id]--;
	ValidateSelectedItem(ent);
...
export bool Pickup_Powerup(entity &ent, entity &other)
{
#ifdef SINGLE_PLAYER

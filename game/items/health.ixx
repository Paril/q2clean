...
export module items.health;

import items.list;

export bool Pickup_Adrenaline(entity &ent, entity &other)
{
#ifdef SINGLE_PLAYER
	if (!deathmatch)
		other.max_health += 1;
...
export bool Pickup_AncientHead(entity &ent, entity &other)
{
	other.max_health += 2;
...
export void MegaHealth_think(entity &self)
{
...
export constexpr spawn_flag HEALTH_IGNORE_MAX = (spawn_flag) 1;
export constexpr spawn_flag HEALTH_TIMED = (spawn_flag) 2;

export bool Pickup_Health(entity &ent, entity &other)
{

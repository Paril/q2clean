...
{
	const int32_t damage = Q_rand_uniform(70, 80) * damage_multiplier;
	const int32_t radius_damage = (ent.client.ps.gunframe == 8 ? 30 : 120) * damage_multiplier;
	const float damage_radius = 120.f;

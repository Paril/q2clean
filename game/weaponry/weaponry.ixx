...
export module weaponry;

import gi;
import math.random;
import util;
import weaponry.handgrenade;

export using fire_func = void(entity &);

export inline vector P_ProjectSource(entity &ent, vector point, vector distance, vector forward, vector right)
{
...
export bool			is_quad;
export muzzleflash	is_silenced;

export int32_t	damage_multiplier;

export void P_DamageModifier(entity &ent)
{
	is_quad = false;
	damage_multiplier = 1;
...
#ifdef SINGLE_PLAYER
export enum player_noise : int32_t
{
	PNOISE_SELF,
	PNOISE_WEAPON,
	PNOISE_IMPACT
...
===============
*/
export void PlayerNoise(entity &who, vector where, player_noise type)
{
...
export void ChangeWeapon(entity &ent)
{
	int i;
...
=================
*/
export void NoAmmoWeaponChange(entity &ent)
{
...
export void Think_Weapon(entity &ent)
{
...
================
*/
export void Weapon_Generic(entity &ent, int32_t FRAME_ACTIVATE_LAST, int32_t FRAME_FIRE_LAST, int32_t FRAME_IDLE_LAST, int32_t FRAME_DEACTIVATE_LAST, std::initializer_list<int32_t> is_pause_frame, std::initializer_list<int32_t> is_fire_frame, fire_func *fire)
{

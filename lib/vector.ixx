...
export constexpr vector vec3_origin { 0, 0, 0 };
...
export [[nodiscard]] constexpr float VectorLengthSquared(const vector &lhs)
{
	return lhs.LengthSquared();
}

// fetch the squared length of lhs
export [[nodiscard]] inline float VectorLength(const vector &lhs)
{
	return lhs.Length();
}

// fetch the squared distance between lhs and rhs
export [[nodiscard]] constexpr float VectorDistanceSquared(const vector &lhs, const vector &rhs)
{
	return lhs.DistanceSquared(rhs);
}

// fetch the distance between lhs and rhs
export [[nodiscard]] inline float VectorDistance(const vector &lhs, const vector &rhs)
{
	return lhs.Distance(rhs);
}

// normalize lhs and return its old length
export inline float VectorNormalize(vector &lhs)
{
...
// bouncing things.
export constexpr float STOP_EPSILON = 0.1f;

// Slide off of the impacting object
export [[nodiscard]] constexpr vector ClipVelocity(const vector &in, const vector &normal, const float &overbounce)
{
...
export template<is_vector_pointer_or_null_pointer TF, is_vector_pointer_or_null_pointer TR, is_vector_pointer_or_null_pointer TU>
...
export [[nodiscard]] inline vector vectoangles(const vector &value1)
{
...
export [[nodiscard]] inline float vectoyaw(const vector &vec)
{
	if (vec.x == 0)
	{
		if (vec.y > 0)
...
export [[nodiscard]] constexpr vector CrossProduct(const vector &v1, const vector &v2)
{
...
export constexpr void AddPointToBounds(const vector &v, vector &mins, vector &maxs)
{
...
export constexpr vector operator*(const float &lhs, const vector &rhs) { return { lhs * rhs.x, lhs * rhs.y, lhs * rhs.z }; }
export constexpr vector operator*(const int32_t &lhs, const vector &rhs) { return { lhs * rhs.x, lhs * rhs.y, lhs * rhs.z }; }
export constexpr vector operator/(const float &lhs, const vector &rhs) { return { lhs / rhs.x, lhs / rhs.y, lhs / rhs.z }; }
export constexpr vector operator/(const int32_t &lhs, const vector &rhs) { return { lhs / rhs.x, lhs / rhs.y, lhs / rhs.z }; }